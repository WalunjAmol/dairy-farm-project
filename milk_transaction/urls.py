...
from .views import MilkTransactionListView, MilkTransactionCreateView, MilkTransactionUpdateView, MilkTransactionDeleteView,import_transactions,datatable_data
